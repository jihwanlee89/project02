...
public interface PaymentMapper {
	...
	boolean lockKeyInsert(TransactionLockModel transactionControllModel);

	boolean lockKeyDelete(TransactionLockModel transactionControllModel);

	int lockKeySelect(TransactionLockModel transactionControllModel);
}
